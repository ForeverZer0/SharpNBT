...
namespace SharpNBT
{
    ...
    public static class VarLong
    {
        ...
        public static int Write([NotNull] Stream stream, long value, bool zigzag = false)
        {
        ...
        public static long Read([NotNull] Stream stream, bool zigzag = false)
        {
        ...
        /// <param name="zigzag">Flag indicating if the value is ZigZag encoded.</param>
        /// <returns>The parsed value read from the <paramref name="stream"/>.</returns>
        public static long Read([NotNull] Stream stream, out int size, bool zigzag = false)
        {
